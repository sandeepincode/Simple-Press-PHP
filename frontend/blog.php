...
<body>
	...
	<h3 align ="center"><i>Articles Shown Below</i></h3>
	</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <!-- we want the below to be in a php funciton to dump out articles-->
                <?php
                //dealing with the getters
                    include 'configFile.php';
                    $index = 1;
                    
                    //checks if its set and a number.
                    ...
                    //changes index if button pressed
                    function changeIndex(){
                        global $index;
                        $direction = safeGet('direction');
                        if($direction == 0 && $index > 1){
                            $index -= 1;
                        }
                        elseif($direction == 2){ //&& $index <= returnNumberOfPublishedArticles()){
                            $index += 1;
                        }
                    }
                    ...
                    function getIndex(){
                        global $index;
                        $temp = safeGet('pageNo');
                        if(($temp > 0)){ //&& ($temp <= returnNumberOfPublishedArticles())){
                            $index = $temp;
                        }
                    }
                    getIndex();
                ...
                <ul class="pager">
                    <?php
                    if($index < (returnNumberOfPublishedArticles()/NUM_ARTICLES)){
                        echo "<li class=\"next\">"
                                ."<a href=\"blog.php?pageNo="
                                .$index."&direction=2".
                                "\">Older Posts &rarr;</a></li>";
                    }
                    if($index > 1){
                        echo "<li class=\"next\">"
                                ."<a href=\"blog.php?pageNo="
                                .$index."&direction=0".
                                "\">&larr; Newer Posts</a></li>";
                    }
                    ?>
                </ul>
            </div>
